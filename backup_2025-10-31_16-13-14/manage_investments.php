    ...
    <nav class="modern-navbar">
      <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand" href="<?php echo $user['role'] === 'admin' ? 'dashboard_admin.php' : 'dashboard_staff.php'; ?>">🏦 Enomy‑Finances <span class="badge bg-<?php echo $user['role'] === 'admin' ? 'danger' : 'info'; ?> ms-2"><?php echo ucfirst($user['role']); ?> Panel</span></a>
          <div class="d-flex align-items-center gap-3">
            <a href="<?php echo $user['role'] === 'admin' ? 'dashboard_admin.php' : 'dashboard_staff.php'; ?>" class="text-decoration-none">← Back to Dashboard</a>
